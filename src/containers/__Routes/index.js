...
import FormBuilder from "../Admin/FormBuild";
import PreviewForm from "../Admin/PreviewForm";
import PreviewMultiStepForm from "../Admin/PreviewMultiStepForm";
import StepperFormBuild from "../Admin/StepperFormBuild";
import Stepper from "../Admin/Stepper";
...
export default function Routes() {
    return (
        <Switch>
            ...
            />
            <PrivateRoute
                path="/multi-step-forms/:id" 
                component={PreviewMultiStepForm}
            />
            <PrivateRoute
                path="/Stepper-form-builder" 
                component={StepperFormBuild}
            />
            <PrivateRoute
                path="/form-builder-stepper/:id" 
                component={Stepper}
            />
            <PrivateRoute
                path="/thankyou" 
